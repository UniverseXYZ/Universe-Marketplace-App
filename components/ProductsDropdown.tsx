    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Content align="center" sideOffset={6}>
        <div
          ...
          className={`w-48 space-y-1  bg-white px-4 py-6 radix-side-bottom:animate-slide-down dark:bg-neutral-900 md:w-[320px] rounded-[12px]`}
        >
          {/* Marketplace */}
          <Link href={`/address/`} legacyBehavior={true}>
            <DropdownMenu.Item asChild>
              <div className="group flex w-full items-center gap-6 px-4 py-3 outline-none transition hover:bg-neutral-100 focus:bg-neutral-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 cursor-pointer rounded-[12px]">
          ...
          <Link href={`/address/`} legacyBehavior={true}>
            <DropdownMenu.Item asChild>
              <div className="group flex w-full items-center gap-6 px-4 py-3 outline-none transition hover:bg-neutral-100 focus:bg-neutral-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 cursor-pointer rounded-[12px]">
                <Avatar address={''} avatar={'/icons/main-nav/minting.svg'} size={40} />
                <div>
                  <p className='text-[14px] leading-6'>Minting</p>
                  <p className='text-[12px] leading-4 text-[#00000066]'>Create NFTs & collections</p>
                </div>
            </div>
            </DropdownMenu.Item>
          </Link>
            ...
            <DropdownMenu.Item asChild>
              <div className="group flex w-full items-center gap-6 px-4 py-3 outline-none transition hover:bg-neutral-100 focus:bg-neutral-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 cursor-pointer rounded-[12px]">
                ...
                <div>
                  ...
                  <p className='text-[12px] leading-4 text-[#00000066]'>Safely seed and store your files</p>
                </div>
            </div>
            </DropdownMenu.Item>
          </Link>
            ...
            <DropdownMenu.Item asChild>
              <div className="group flex w-full items-center gap-6 px-4 py-3 outline-none transition hover:bg-neutral-100 focus:bg-neutral-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 cursor-pointer rounded-[12px]">
                ...
                <div>
                  ...
                  <p className='text-[12px] leading-4 text-[#00000066]'>Showcase your favourites on any screen</p>
                </div>
            </div>
            </DropdownMenu.Item>
          </Link>
