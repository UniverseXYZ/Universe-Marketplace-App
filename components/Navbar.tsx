    ...
    <nav className="sticky top-0 z-[1000] col-span-full flex items-center justify-between gap-2 border-b border-[#D4D4D4] bg-white px-6 py-4 dark:border-neutral-600 dark:bg-black md:gap-3 md:py-4 md:px-16">
      ...
      {isMobile ? (
        ...
        <div className="z-10 ml-auto shrink-0 gap-2 md:flex xl:gap-4">
          ...
          <CartMenu />
          {/* Sell */}
          <div className={`items-center md:flex ${account.isConnected ? 'bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] hover:from-[#bceb00cc] hover:to-[#00eaeacc]' : 'bh-white border-[1px] hover:bg-[#0000000d]'}  rounded-lg cursor-pointer`}>
