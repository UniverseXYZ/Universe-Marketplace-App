...
import { ListModal, useReservoirClient } from '../reservoir-kit-ui/src'
      ...
      >
        ...
        {isOwner && (
          <div className="grid">
            <ListModal
              trigger={
                <button className="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] hover:from-[#bceb00cc] hover:to-[#00eaeacc] duration-[100s] border-none text-black reservoir-subtitle flex h-[40px] items-center justify-center whitespace-nowrap rounded-none text-white focus:ring-0">
          ...
          !isOwner && (
            ...
            >
              <BuyNow
                ...
                buttonClassName="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] hover:from-[#bceb00cc] hover:to-[#00eaeacc] duration-[100s] border-none text-black reservoir-subtitle flex h-[40px] items-center justify-center whitespace-nowrap rounded-none text-white focus:ring-0"
              />
              {isInCart && (
                <button
                  onClick={() => {
