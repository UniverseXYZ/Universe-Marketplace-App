          ...
          {account.isDisconnected ? (
            ...
            <>
              {isOwner && (
                <ListModal
                  trigger={
                    <button className="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA]  hover:from-[#bceb00cc] hover:to-[#00eaeacc] duration-[100s] border-none text-black w-full dark:ring-primary-900 dark:focus:ring-4">
              ...
              {!isOwner && (
                <BuyNow
                  buttonClassName="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA]  hover:from-[#bceb00cc] hover:to-[#00eaeacc] duration-[100s] border-none text-black col-span-1"
                  data={{
                    details: details,
                  }}
                  signer={signer}
