                ...
                <div className="mx-auto overflow-hidden rounded-2xl border border-neutral-300 bg-white p-11 shadow-xl dark:border-neutral-600 dark:bg-black md:w-[637px]">
                  ...
                  <div className="flex gap-4">
                    <Dialog.Close
                      ...
                      className="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] border-none w-full dark:border-neutral-600  dark:text-white dark:ring-primary-900 dark:focus:ring-4"
                    >
                      Yes
                    </Dialog.Close>
                    <Dialog.Close
