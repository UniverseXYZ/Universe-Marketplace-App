          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-center pt-4">
                <AcceptBidModal
                  trigger={
                    <button className="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] border-none mr-2 w-full min-w-[120px] py-2 text-sm focus:ring-0 sm:w-auto">
                      <FaBolt />
                      Sell
                    </button>
                  }
              ...
              >
                ...
                <td className="whitespace-nowrap dark:text-white">
                  <div className="flex items-center">
                    <AcceptBidModal
                      trigger={
                        <button className="btn-primary-fill bg-gradient-to-r from-[#BCEB00] to-[#00EAEA] border-none mr-3 min-w-[120px] justify-center py-2 text-sm">
                          <FaBolt />
                          Sell
                        </button>
                      }
